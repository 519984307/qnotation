...
#define Q_NOTATION_DECLARE_VALUE(NAME, CLASSIFICATION, VALUE) \
    const QVariantHash NAME = Q_NOTATION_COMPOSE(NAME, CLASSIFICATION, VALUE, true);

#define Q_NOTATION_DECLARE(NAME, CLASSIFICATION) \
    Q_NOTATION_DECLARE_VALUE(NAME, CLASSIFICATION, true);
